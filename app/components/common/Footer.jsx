      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <Link href="/" className="text-xl font-bold text-white hover:text-blue-300 transition duration-200 flex items-center">
              <span className="mr-2">🧠</span>
              PrePostTEST
            </Link>
            <p className="text-gray-400 mt-2 text-sm">A platform for interactive quiz experiences</p>
          </div>
